...
At first we solve the most simple problem in the data.
...
Now we can start to clean the participants variable
--# Problem 3: Completing participants_category variable  


```{r data-wrangling}

ProtestOnlyDates[is.na(participants_category)
  ...
  # Getting number by using regular expressions
  ...
  ][, rbind(.SD,ProtestOnlyDates[!is.na(participants_category)])
  ...
  ][, sum(participants_range == "Missing")]
