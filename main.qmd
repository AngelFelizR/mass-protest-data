...
WorldCities[, .(city_regex = city_ascii |> str_to_lower() |> str_c(collapse = "|")),
            by = .(country,
                   capital_city = str_to_lower(capital_city))
...
WorldCities[country == "Dominican Republic"]
